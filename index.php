...
if(!empty($_SERVER['QUERY_STRING']) && is_numeric($_SERVER['QUERY_STRING'])) {
	...
	$domain['defaultindex'] = 'homepage.php';
	$_ENV['domain'] = $domain;
	if(empty($_ENV['domain'])) {
		$_ENV['curapp'] = 'homepage';
		// $_ENV['curapp'] = 'forum';
	} else {
		$_ENV['defaultapp'] = array('portal.php'=>'portal', 'forum.php'=>'forum', 'group.php'=>'group', 'home.php'=>'home', 'homepage.php'=>'homepage');
