...
$lang = array(
	...
	'tips_ucenter_comment' => 'UCenter 是 Comsenz 公司产品的核心服务程序， Board 的安装和运行依赖此程序。如果您已经安装了 UCenter，请填写以下信息。否则，请到 <a href="http://www.wincomtech.cn/" target="blank">Wincomtech 产品中心</a> 下载并且安装，然后再继续。',
	...
	'install_dzfull' => '<br><label><input type="radio"'.(getgpc('install_ucenter') != 'no' ? ' checked="checked"' : '').' name="install_ucenter" value="yes" onclick="if(this.checked)$(\'form_items_2\').style.display=\'none\';" /> 全新安装 Wincomtech! X (含 UCenter Server)</label>',
	'install_dzonly' => '<br><label><input type="radio"'.(getgpc('install_ucenter') == 'no' ? ' checked="checked"' : '').' name="install_ucenter" value="no" onclick="if(this.checked)$(\'form_items_2\').style.display=\'\';" /> 仅安装 Wincomtech! X (手工指定已经安装的 UCenter Server)</label>',
	...
	'uc_version_incorrect' => '您的 UCenter 服务端版本过低，请升级 UCenter 服务端到最新版本，并且升级，下载地址：http://www.wincomtech.cn/ 。',
	'config_unwriteable' => '安装向导无法写入配置文件, 请设置 config.inc.php 程序属性为可写状态(777)',

	'install_in_processed' => '正在安装...',
	'install_succeed' => '安装成功，点击进入',
	'install_cloud' => '安装成功，欢迎开通云平台<br>Hielec!云平台致力于帮助站长提高网站流量，增强网站运营能力，增加网站收入。<br>Hielec!云平台目前免费提供了QQ互联、腾讯分析、纵横搜索、漫游应用、SOSO表情服务。云平台将陆续提供更多优质服务项目。<br>开通平台之前，请确保您的网站（、UCHome或SupeSite）已经升级到 X3。',
	...
	'init_link' => ' 官方论坛',
	'init_link_note' => '提供最新 Wincomtech! 产品新闻、软件下载与技术交流',
...
<p>版权所有 (c) 2017-2027，北京康盛新创科技有限责任公司保留所有权利。</p>

<p>感谢您选择康盛产品。希望我们的努力能为您提供一个高效快速、强大的站点解决方案，和强大的社区论坛解决方案。康盛公司网址为 http://www.wincomtech.cn，产品官方讨论区网址为 http://www.discuz.net。</p>
...
<h3>II. 协议规定的约束和限制</h3>
<ol>
   <li>未获康盛公司书面商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http://www.wincomtech.cn参考相关说明，也可以致电8610-51282255了解详情。</li>
   <li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
   <li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用康盛产品的整体或任何部分，未经书面许可，页面页脚处的康盛产品名称和康盛公司下属网站（http://www.wincomtech.cn、或 http://www.discuz.net） 的链接都必须保留，而不能清除或修改。</li>
