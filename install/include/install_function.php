...
<div class="container">
	<div class="header">
		<h1>$title</h1>
		<span>Hielec!$version $install_lang $release</span>
EOT;
...
function show_footer($quit = true) {
	...
	echo <<<EOT
		<div class="footer">&copy;2001 - 2013 <a href="http://www.wincomtech.cn/">Comsenz</a> Inc.</div>
	</div>
</div>
</body>
</html>
...
function install_uc_server() {
	...
	$db->query("INSERT INTO {$uctablepre}applications SET name=' Board', url='$appurl', ip='$ucip', authkey='$appauthkey', synlogin='1', charset='$charset', dbcharset='$dbcharset', type='DISCUZX', recvnote='1', tagtemplates='$apptagtemplates'", $link);
