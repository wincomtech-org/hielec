		...
		<table class="mainbox">
			<tr>
				...
				<td class="login">
					...
					<p class="loginbtn"><input type="submit" name="submit" value="登 录" class="btn" tabindex="3" /><a href="http://www.wincomtech.cn/viewnews-925" target="_blank" class="rstpsw">找回密码</a></p>
				</td>
			</tr>
		</table>
	</form>
...
<div class="footer">Powered by UCenter <?php echo UC_SERVER_VERSION;?> &copy; 2001 - 2011 <a href="http://www.wincomtech.cn/" target="_blank">Comsenz</a> Inc.</div>
