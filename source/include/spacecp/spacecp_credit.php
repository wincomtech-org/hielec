...
$operation = in_array($_GET['op'], array('base', 'buy', 'withdraw', 'transfer', 'exchange', 'log', 'rule')) ? trim($_GET['op']) : 'base';
$opactives = array($operation =>' class="a"');
if(in_array($operation, array('base', 'buy', 'withdraw', 'transfer', 'exchange', 'rule'))) {
	$operation = 'base';
}
