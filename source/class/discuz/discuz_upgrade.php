...
class discuz_upgrade {
	...
	public function fetch_updatefile_list($upgradeinfo) {
		...
		$file = DISCUZ_ROOT.'./data/update/ X'.$upgradeinfo['latestversion'].' Release['.$upgradeinfo['latestrelease'].']/updatelist.tmp';
	...
	public function download_file($upgradeinfo, $file, $folder = 'upload', $md5 = '', $position = 0, $offset = 0) {
		$dir = DISCUZ_ROOT.'./data/update/ X'.$upgradeinfo['latestversion'].' Release['.$upgradeinfo['latestrelease'].']/';
