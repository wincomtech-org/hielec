...
EOT;
		...
		$helplink = '';
		if($type == 'db') {
			$helplink = "http://www.wincomtech.cn/?type=mysql&dberrno=".rawurlencode(DB::errno())."&dberror=".rawurlencode(str_replace(DB::object()->tablepre, '', DB::error()));
...
<tr>
	<td id="bodytitle" width="100%">Hielec! $title Error </td>
</tr>
EOT;
