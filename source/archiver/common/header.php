...
<title><?php if(!empty($navtitle)): echo $navtitle.' - '; endif; if(empty($nobbname)): echo $_G['setting']['bbname'].' - '; endif;?> Powered by Wincomtech! Archiver</title>
...
<meta name="copyright" content="2017-2027 Comsenz Inc." />
<style type="text/css">
