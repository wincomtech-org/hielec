...
$lang = array (
  ...
  'plugins_install_succeed' => '插件成功安装！<br />为了正常使用此插件，您可能还需要上传或修改相应的文件或模板，详情请查看本插件的安装说明<br /><br /><a href="http://admin.php?action=plugins?view=plugins">点击这里返回应用中心</a><br />',
  'plugin_file_error' => '插件文件缺失',
  'plugins_edit_identifier_invalid' => '您输入的唯一标识符不合法或与现有插件重复',
  'plugins_upgrade_succeed' => '插件成功更新到 {toversion}<br /><br /><a href="http://admin.php?action=plugins?view=plugins">点击这里返回应用中心</a><br />',
  ...
  'database_run_query_succeed' => ' 数据结构升级成功，影响的记录行数 {affected_rows}',
  ...
  'plugins_import_version_invalid_confirm' => '本插件适用于 Wincomtech! {cur_version} 与当前版本({set_version})不一致，您确定要安装吗？<br />如果本插件的安装说明中不包含修改文件的内容则说明此插件为绿色插件，您可放心安装',
  'plugins_import_version_invalid' => '本插件适用于 Wincomtech! {cur_version} 与当前版本({set_version})不一致',
  ...
  'plugins_config_upgrade_missed' => '此插件已更新到最新版本</h4><br /><a href="{ADMINSCRIPT}action=plugins" class="lightlink">点击这里进入应用中心</a><br /><br /><h4>',
  'plugins_config_upgrade_new' => '此插件已更新到最新版本<br />但是发现此插件在应用中心存在新版本 {newver}，是否需要升级？</h4><br /><a href="http://admin.php?action=plugins?@{addonid}" class="lightlink">升级此插件</a> &nbsp;&nbsp; <a href="{ADMINSCRIPT}?action=plugins" class="lightlink">暂不升级</a><h4>',
  ...
  'styles_install_succeed' => '界面方案安装完成<br /><br /><a href="http://admin.php?action=plugins?view=templates">点击这里返回应用中心</a><br />',
  ...
  'upgrade_successful' => '恭喜您，升级成功! <br />您当前的版本为：[ X{version} Release[{release}] <br /><br />为安全起见，升级文件已保存至{save_update_dir}目录，<br />备份文件已保存至{save_back_dir}目录 {upgradeurl}',
  ...
  'cloudaddons_check_url_fopen_error' => '您的服务器无法访问应用中心，这将会导致应用无法安装。请联系您的服务商或者网站技术人员，确保您的服务器能够正常访问 admin.php?action=plugins 或 addon1.discuz.com',
