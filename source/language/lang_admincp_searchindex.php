...
$lang = array (
  ...
  array (
    ...
    array (
      0 => '站点广告 &raquo; 广告位',
      1 => 'adv_list_tip',
      2 => '您可以使用“自定义广告位”在页面的任意位置添加广告位。系统广告位位于 source/class/adv/ 目录中，插件广告位位于 source/plugin/插件目录/adv/ 目录中。插件开发人员在设计新的广告位前请务必仔细阅读《 技术文库》中的内容。联盟免费提供更丰富的广告形式，让您赚取更丰厚的广告收益，快来看看吧。',
    ),
  ),
  155 =>
  array (
  ...
  array (
    ...
    array (
      ...
      9 => 'announce_message',
      10 => '内容',
      11 => '文字公告: 直接输入公告内容，支持 Wincomtech! 代码网址链接: 请输入公告的链接地址如某个主题地址: http://xxx.xxx.xxx',
    ),
  ),
  159 =>
  array (
    ...
    array (
      0 => '第三方模块 &raquo; 搜索',
      1 => 'blockxml_tips',
      2 => '插件开发人员在设计新的第三方模块前请务必仔细阅读《 技术文库》中的内容。',
      3 => 'blockxml_add',
      4 => '添加 第三方模块',
      5 => 'blockxml_xmlurl',
      6 => '第三方地址',
  ...
  array (
    ...
    array (
      ...
      18 => '备份文件名',
      19 => 'db_import_tips',
      20 => '本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将论坛关闭，恢复全部完成后可以将论坛重新开放。恢复数据前请在 Wincomtech! X2.5 安装文件目录下utility文件夹内找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。',
      21 => 'db_import',
      22 => '数据恢复',
    ),
  ),
  ...
  array (
    ...
    array (
      0 => '数据库 &raquo; 升级',
      1 => 'db_runquery_tips',
      2 => '您可以通过修改 /source/admincp/admincp_quickquery.php 来添加常用 SQL 操作进行功能扩充。出于安全考虑， 后台默认情况下禁止 SQL 语句直接执行，只能使用常用 SQL 当中的内容，如果您想自己随意书写 SQL 升级语句，需要将 config/config_global.php 当中的 $_config[admincp][runquery] 设置修改为 1。',
      3 => 'db_runquery_simply',
      4 => '常用 SQL 升级语句',
      5 => 'db_runquery_sql',
      6 => ' 数据库升级 - 请将数据库升级语句粘贴在下面',
    ),
  ),
  176 =>
  array (
  ...
  array (
    ...
    array (
      0 => '电子商务 &raquo; 支付宝',
      1 => 'ec_alipay_tips',
      2 => '“支付宝”(http://www.alipay.com)是中国领先的网上支付平台，由全球最佳 B2B 公司阿里巴巴公司创建，为 Wincomtech! 用户提供积分购买及论坛 B2C、C2C 交易平台。您只需进行简单的设置，即可使论坛内容和人气，真成为除广告收入外的重要利润来源，从而实现论坛的规模化经营。由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用支付宝积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。支付宝积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款支付宝账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Wincomtech! 官方网站或官方论坛另行通知以外， 提供的支付宝支付服务每笔交易收取 1.5% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Wincomtech! 官方网站或官方论坛提供的信息为准。您使用支付宝服务是建立在完全自愿的基础上，除 Wincomtech! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。支付宝业务咨询 Email 为 6688@taobao.com；支付宝客户服务电话为 +86-0571-88156688。',
      3 => 'ec_alipay',
      4 => '支付宝设置',
      5 => 'ec_alipay_account',
      6 => '收款支付宝账号',
  ...
  array (
    ...
    array (
      0 => '电子商务 &raquo; 财付通',
      1 => 'ec_tenpay_tips',
      2 => '“财付通”(http://www.tenpay.com)是腾讯公司创办的中国领先的在线支付平台，为 Wincomtech! 用户提供积分购买交易平台。如需启用积分充值即时到账，请使用财付通企业版并开通即时到账交易；否则，只需要开通“中介担保交易”即可。
由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Wincomtech! 官方网站或官方论坛另行通知以外， 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Wincomtech! 官方网站或官方论坛提供的信息为准。您使用财付通服务是建立在完全自愿的基础上，除 Wincomtech! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
  ...
  array (
    ...
    array (
      ...
      25 => '版块转向 URL',
      26 => '如果设置转向 URL(例如 http://www.wincomtech.cn)，用户点击本分版块将进入转向中设置的 URL。一旦设定将无法进入版块页面，请确认是否需要使用此功能，留空为不设置转向 URL',
      27 => 'forums_edit_basic_description',
      28 => '版块简介',
      29 => '将显示于版块名称的下面，提供对本版块的简短描述支持内置的 Wincomtech! 代码',
      30 => 'forums_edit_basic_rules',
      31 => '本版块规则',
      32 => '显示于主题列表页的当前版块规则，留空为不显示支持内置的 Wincomtech! 代码',
      33 => 'forums_edit_basic_keys',
      34 => '绑定别名',
      35 => '绑定后当站点开启 URL 静态化后可通过别名访问此版块，如设置别名为“developer”那么版块的 URL 将变为“http://127.0.0.1/x/tools/language_template/forum-developer-1.html”。注意：别名中只能包含字母或数字，且不能是纯数字',
  ...
  array (
    ...
    array (
      0 => '道具中心',
      1 => 'magics_tips',
      2 => '系统道具位于 source/class/magic/ 目录中，插件道具位于 source/plugin/插件目录/magic/ 目录中插件开发人员在设计新的道具前请务必仔细阅读《 技术文库》中的内容。',
  ...
  array (
    ...
    array (
      ...
      2 => ' 支持对用户 8 种扩展积分的设置，只有被启用的积分才允许您进行编辑。修改用户的某项积分会造成该用户总积分的变化，从引起普通会员等级的变化，因此请仔细设置各项积分。',
  ...
  array (
    ...
    array (
      '编辑器设置' => 'action=setting&operation=editor',
      ' 代码' => 'action=setting&operation=bbcode',
    ),
    'text' =>
    array (
      0 => '编辑器设置 &raquo; Wincomtech! 代码',
      1 => 'misc_bbcode_edit_tips',
      2 => '只有在自定义 Wincomtech! 代码可用并设置了图标文件时，具有“允许使用自定义 Wincomtech! 代码”权限的用户组在发帖时才会看到相应自定义 Wincomtech! 代码按钮。',
    ),
  ),
  220 =>
  array (
  ...
  array (
    ...
    array (
      0 => '计划任务',
      1 => 'misc_cron_tips',
      2 => '计划任务是 Wincomtech! 提供的一项使系统在规定时间自动执行某些特定任务的功能，在需要的情况下，您也可以方便的将其用于站点功能的扩展。计划任务是与系统核心紧密关联的功能特性，不当的设置可能造成站点功能的隐患，严重时可能导致站点无法正常运行，因此请务必仅在您对计划任务特性十分了解，并明确知道正在做什么、有什么样后果的时候才自行添加或修改任务项目。此处和其他功能不同，本功能中完全按照站点系统默认时差对时间进行设定和显示，而不会依据某一用户或管理员的时差设定而改变显示或设置的时间值。',
    ),
  ),
  226 =>
  array (
...
',
  ...
  array (
    ...
    array (
      ...
      20 => '显示授权信息链接',
      21 => '选择“是”将在页脚显示商业授权用户链接，链接将指向 Wincomtech! 官方网站，用户可通过此链接验证其所使用的 Wincomtech! 是否经过商业授权',
  ...
  array (
    ...
    array (
      ...
      33 => '注册地址:',
      34 => '设置站点注册地址 mod 值，默认为“register”，修改名称有利于防止灌水软件，有别于 Wincomtech! X 之前的版本更改了此设置，不需要修改任何文件名称，只在此修改即可',
  ...
  array (
    ...
    array (
      ...
      2 => '{标记} 不含参数的贴内用户信息标记调用。{标记=参数} 含参数的贴内用户信息标记调用，多个参数用","分割{标记}HTML{*}HTML{/标记} 当有调用内容有值时显示 {*} 前后的 HTML 内容“plugin:插件标识”格式的标记为插件增加的贴内用户信息标记调用。插件开发人员在设计新的贴内用户信息标记前请务必仔细阅读《 技术文库》中的内容。',
  ...
  array (
    ...
    array (
      ...
      19 => '用户在线时间更新时长(分钟)',
      20 => ' 可统计每个用户总共和当月的在线时间，本设置用以设定更新用户在线时间的时间频率。例如设置为 10，则用户每在线 10 分钟更新一次记录。本设置值越小，则统计越精确，但消耗资源越大。建议设置为 5～30 范围内，0 为不记录用户在线时间',
  ...
  array (
    ...
    array (
      ...
      2 => '验证问题应该言简意赅，没有歧义，正常人都能够正确作答。请经常更新验证问答的问题及答案以防止被猜测！系统验证问答位于 source/class/secqaa/ 目录中，插件验证问答位于 source/plugin/插件目录/secqaa/ 目录中。插件开发人员在设计新的验证问答脚本前请务必仔细阅读《 技术文库》中的内容。',
  ...
  array (
    ...
    array (
      ...
      32 => '图片处理库类型',
      33 => '请选择 Wincomtech! 用来处理缩略图和水印的图像处理库。GD 是最广泛的处理库但是使用的系统资源较多。ImageMagick 速度快系统资源占用少，但需要服务器有执行命令行命令的权限。如果您的服务器有条件安装此程序，请到 http://www.imagemagick.org 下载，安装后在下面指定安装的路径',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
  ...
  array (
    ...
    array (
      ...
      6 => 'setting_uc_key',
      7 => 'UCenter 通信密钥',
      8 => '通信密钥用于在 UCenter 和 Wincomtech! 之间传输信息的加密，可包含任何字母及数字，请在 UCenter 与 Wincomtech! 设置完全相同的通讯密钥，以确保两套系统能够正常通信',
      9 => 'setting_uc_api',
      10 => 'UCenter 访问地址',
  ...
  array (
    ...
    array (
      0 => '用户组',
      1 => 'usergroups_tips',
      2 => '用户组分为系统组、会员组和自定义组，会员组以积分确定组别和权限，而系统组和自定义组是人为设定，不会由系统自行改变。系统组和自定义组的设定不需要指定积分， 预留了从站点管理员到游客等的 8 个系统头衔，自定义组的用户需要在编辑会员时将其加入。会员用户组至少分为两组，其积分下限分别为负值(任一负数)和 0，否则将导致部分用户无法与用户组匹配的问题。',
    ),
  ),
  304 =>
  array (
  ...
  array (
    ...
    array (
      ...
      34 => '允许签名中使用 Wincomtech! 代码',
      35 => '设置是否解析用户签名中的 Wincomtech! 代码',
