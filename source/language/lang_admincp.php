...
(
	...
	'subscribe_comsenz_email' => '填写您的邮件地址，订阅 Wincomtech! 官方产品动态、安全提醒、官方新闻',
	'scan_discuz_qrcode' => '<img src="source/plugin/wechat/image/discuz_qr.jpg" align="left" width="80" /><br />扫描关注官方微信<br /><br />获取官方最新动态',
	...
	'nav_posting_bbcode' => '编辑 icyun! 代码',
	...
	'patch_fix_complete' => 'icyun! 重要安全更新: 您已修复了全部严重安全漏洞<span>点击查看</span>',
	'patch_fix_rigth_now' => 'icyun! 重要安全更新: 您目前的版本存在严重安全漏洞，请尽快修复<span>立即修复</span>',
	...
	'upgrade_right_now' => '您目前使用的 icyun! 程序有新版本发布，请及时升级<span>在线升级</span>',
	...
	'makehtml_tips_index' => '<li>生成门户首页的HTML文件，文件名可在设置里单独指定，默认为index</li><li>服务器端设置默认访问文件时，应将生成的静态文件名放在index.php之前，如：DirectoryIndex index.html index.php</li><li>使用静态文件访问时，原有的某些不带index.php的动态访问将失效，如：http://www.wincomtech.cn/?1</li>',
	...
	'login_tips' => 'icyun! 是一个采用 PHP 和 MySQL 等多种数据库构建的高效建站解决方案，是众多 BBS 网站首选技术品牌!',
	...
	'home_security_service_close_info' => '<li>推荐您开通云平台, 开通后，当站点程序出现严重安全漏洞需要立即进行修补的时候，我们会通过QQ及时通知给您<br/><a href="?action=plugins">点击<strong>"云平台->开通icyun!云平台"</strong>开通此功能</a></li>',
	'home_security_service_open_info' => '<li>您已开通云平台，当站点程序出现严重安全漏洞需要立即进行修补的时候，我们会通过QQ及时通知给您。<br/>平台管理入口：<a href="?action=cloud&operation=applist"><strong>"云平台->管理icyun!云平台"</strong></a></li>',
	...
	'home_sys_info' => '系统信息',
	'home_discuz_version' => 'icyun! 程序版本',
	...
	'setting_basic_site_qq_comment' => '<a href="" onclick="this.href=\'http://wp.qq.com/set.html?from=icyun&uin=\'+$(\'settingnew[site_qq]\').value" target="_blank">设置我的QQ在线状态</a>',
	...
	'setting_basic_boardlicensed_comment' => '选择“是”将在页脚显示商业授权用户链接，链接将指向 icyun! 官方网站，用户可通过此链接验证其所使用的 icyun! 是否经过商业授权',
	...
	'setting_access_register_name_comment' => '设置站点注册地址 mod 值，默认为“register”，修改名称有利于防止灌水软件，有别于 icyun! X 之前的版本更改了此设置，不需要修改任何文件名称，只在此修改即可',
	...
	'setting_threadprofile_tpl_tpls' => '<li>{<b>标记</b>} 不含参数的贴内用户信息标记调用。</li><li>{<b>标记</b>=<b>参数</b>} 含参数的贴内用户信息标记调用，多个参数用","分割</li><li>{<b>标记</b>}<b>HTML</b>{<b>*</b>}<b>HTML</b>{/<b>标记</b>} 当有调用内容有值时显示 {*} 前后的 HTML 内容</li><li>“<b>plugin:插件标识</b>”格式的<b>标记</b>为插件增加的贴内用户信息标记调用。插件开发人员在设计新的贴内用户信息标记前请务必仔细阅读</li>',
...
',
	...
	'setting_functions_other_oltimespan_comment' => 'icyun! 可统计每个用户总共和当月的在线时间，本设置用以设定更新用户在线时间的时间频率。例如设置为 10，则用户每在线 10 分钟更新一次记录。本设置值越小，则统计越精确，但消耗资源越大。建议设置为 5～30 范围内，0 为不记录用户在线时间',
	...
	'setting_sec_qaa_tips' => '<li>验证问题应该言简意赅，没有歧义，正常人都能够正确作答。请经常更新验证问答的问题及答案以防止被猜测！</li><li>系统验证问答位于 source/class/secqaa/ 目录中，插件验证问答位于 source/plugin/插件目录/secqaa/ 目录中。</li><li>插件开发人员在设计新的验证问答脚本前请务必仔细阅读。</li>',
	...
	'setting_attach_image_lib_comment' => '请选择 icyun! 用来处理缩略图和水印的图像处理库。GD 是最广泛的处理库但是使用的系统资源较多。ImageMagick 速度快系统资源占用少，但需要服务器安装 ImageMagick 扩展。如果您的服务器有条件安装此程序，请到 <a href="http://www.imagemagick.org" target="_blank">http://www.imagemagick.org</a> 下载',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'setting_uc_key_comment' => '通信密钥用于在 UCenter 和 icyun! 之间传输信息的加密，可包含任何字母及数字，请在 UCenter 与 icyun! 设置完全相同的通讯密钥，以确保两套系统能够正常通信',
	...
	'forums_edit_basic_redirect_comment' => '如果设置转向 URL(例如 http://www.wincomtech.cn)，用户点击本分版块将进入转向中设置的 URL。一旦设定将无法进入版块页面，请确认是否需要使用此功能，留空为不设置转向 URL',
	...
	'forums_edit_basic_description_comment' => '将显示于版块名称的下面，提供对本版块的简短描述<br />支持内置的 icyun! 代码',
	'forums_edit_basic_rules' => '本版块规则',
	'forums_edit_basic_rules_comment' => '显示于主题列表页的当前版块规则，留空为不显示<br />支持内置的 icyun! 代码',
	...
	'forums_edit_posts_bbcode' => '允许使用icyun!代码',
	'forums_edit_posts_bbcode_comment' => 'icyun! 代码是一种简化和安全的页面格式代码',
	...
	'styles_edit_visual_text' => '<p id="sp_tabletext" style="margin: 0; line-height: 1.6em; color: #444;"><a id="sp_link" href="http://www.wincomtech.cn" target="_blank" style="color: #09C; text-decoration: none;">Crossday icyun! Board</a> 论坛系统<span id="sp_midtext" style="color: #666;">(简称 <strong id="sp_notice" style="color: #F60;">icyun!</strong> 论坛)</span>是一个采用 PHP 和 MySQL 等其他多种数据库构建的高效建站解决方案。</p>',
	...
	'styles_import_ignore_version' => '允许导入老版本 icyun! 的界面(易产生错误!!)',
	...
	'members_credit_tips' => '<li>icyun! 支持对用户 8 种扩展积分的设置，只有被启用的积分才允许您进行编辑。</li><li>修改用户的某项积分会造成该用户总积分的变化，从引起普通会员等级的变化，因此请仔细设置各项积分。</li>',
	...
	'members_newsletter_mobile_tips' => '<li>您可以通过该功能给手机客户端用户发送通知，为了您更好的触达用户建议大力推广我们的手机客户端。</li><li>要使用本功能需要开启云平台服务、手机客户端插件</li>',
	...
	'admingroup' => '管理组',
	'admingroup_tips' => '<li>icyun! 管理组包括管理员、超级版主、版主三个内置管理组以及自定义管理组。</li>',
	...
	'usergroups_tips' => '<li>用户组分为系统组、会员组和自定义组，会员组以积分确定组别和权限，而系统组和自定义组是人为设定，不会由系统自行改变。</li><li>系统组和自定义组的设定不需要指定积分，icyun! 预留了从站点管理员到游客等的 8 个系统头衔，自定义组的用户需要在编辑会员时将其加入。</li><li>会员用户组至少分为两组，其积分下限分别为负值(任一负数)和 0，否则将导致部分用户无法与用户组匹配的问题。</li>',
	...
	'usergroups_edit_post_custom_bbcode' => '允许使用自定义 icyun! 代码',
	'usergroups_edit_post_custom_bbcode_comment' => '设置是否解析用户帖子中的自定义 icyun! 代码。注意: 自定义 icyun! 代码由管理团队成员在管理中心中自行定义，不包括系统内置的数十种代码',
	'usergroups_edit_post_bio_bbcode' => '允许自我介绍中使用 icyun! 代码',
	'usergroups_edit_post_bio_bbcode_comment' => '设置是否解析用户自我介绍中的 icyun! 代码',
	...
	'usergroups_edit_post_sig_bbcode' => '允许签名中使用 icyun! 代码',
	'usergroups_edit_post_sig_bbcode_comment' => '设置是否解析用户签名中的 icyun! 代码',
	...
	'quickquery_open_discuzcode' => '开启 所有版块 icyun! 代码',
	...
	'quickquery_close_discuzcode' => '关闭 所有版块 icyun! 代码',
	...
	'announce_message' => '内容',
	'announce_message_comment' => '<b>文字公告:</b> 直接输入公告内容，支持 icyun! 代码<br /><b>网址链接:</b> 请输入公告的链接地址如某个主题地址: http://xxx.xxx.xxx',
	...
	'misc_bbcode' => '自定义 icyun! 代码',
	'misc_bbcode_edit' => '编辑 icyun! 代码',
	'misc_bbcode_edit_tips' => '<li>只有在自定义 icyun! 代码可用并设置了图标文件时，具有“允许使用自定义 icyun! 代码”权限的用户组在发帖时才会看到相应自定义 icyun! 代码按钮。</li>',
	'misc_bbcode_tag' => '标签',
	...
	'misc_cron_tips' => '<li>计划任务是 icyun! 提供的一项使系统在规定时间自动执行某些特定任务的功能，在需要的情况下，您也可以方便的将其用于站点功能的扩展。</li><li>计划任务是与系统核心紧密关联的功能特性，不当的设置可能造成站点功能的隐患，严重时可能导致站点无法正常运行，因此请务必仅在您对计划任务特性十分了解，并明确知道正在做什么、有什么样后果的时候才自行添加或修改任务项目。</li><li>此处和其他功能不同，本功能中完全按照站点系统默认时差对时间进行设定和显示，而不会依据某一用户或管理员的时差设定而改变显示或设置的时间值。</li>',
	...
	'misc_cron_edit_tips' => '<li>您正在对系统内置的计划任务进行编辑，除非非常了解 icyun! 结构，否则强烈建议不要修改默认设置。</li><li>请在修改之前记录原有设置，不当的设置将可能导致站点出现不可预期的错误。</li>',
	...
	'plugins_add' => '设计新插件',
	'plugins_add_tips' => '<li><b>本功能仅供插件开发者使用。</b></li><li>插件开发人员在使用本功能前请务必仔细阅读。</li><li>警告: 不正确的插件设计或安装可能危及到整个站点的正常使用。</li>',
	'plugins_import' => '导入插件数据',
	'plugins_import_ignore_version' => '允许导入老版本 icyun! 的插件(易产生错误!!)',
	...
	'plugins_edit_tips' => '<li><b>本功能仅供插件开发者使用，如果您只是安装或使用本插件，切勿修改本设置。</b></li><li>插件开发人员在使用本功能前请务必仔细阅读</li><li>警告: 不正确的插件设计或安装可能危及到整个站点的正常使用。</li>',
	...
	'magics' => '道具中心',
	'magics_tips' => '<li>系统道具位于 source/class/magic/ 目录中，插件道具位于 source/plugin/插件目录/magic/ 目录中</li><li>插件开发人员在设计新的道具前请务必仔细阅读',
	...
	'tasks_tips_add_type' => '<li>系统任务位于 source/class/task/ 目录中，插件任务位于 source/plugin/插件目录/task/ 目录中。</li>',
	'tasks_edit' => '编辑任务',
	'tasks_list' => '任务列表',
	...
	'ec_alipay' => '支付宝设置',
	'ec_alipay_tips' => '<li>“支付宝”(<a href="http://www.alipay.com" target="_blank">http://www.alipay.com</a>)是中国领先的网上支付平台，由全球最佳 B2B 公司阿里巴巴公司创建，为 icyun! 用户提供积分购买及论坛 B2C、C2C 交易平台。您只需进行简单的设置，即可使论坛内容和人气，真成为除广告收入外的重要利润来源，从而实现论坛的规模化经营。</li><li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用支付宝积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。支付宝积分交易功能，需在“<a href="'.$BASESCRIPT.'?action=setting&operation=credits" target="_blank">积分设置</a>”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款支付宝账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 icyun! 官方网站或官方论坛另行通知以外，icyun! 提供的支付宝支付服务每笔交易收取 1.5% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 icyun! 官方网站或官方论坛提供的信息为准。</li><li>您使用支付宝服务是建立在完全自愿的基础上，除 icyun! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>支付宝业务咨询 Email 为 <a href="mailto:6688@taobao.com">6688@taobao.com</a>；支付宝客户服务电话为 +86-0571-88156688。</li>',
	...
	'ec_alipay_contract_comment' => '如果您的支付宝账号是签约用户，可以选择“是”让论坛使用您自己的商家服务平台。如果您还未签约，<a href="http://act.life.alipay.com/systembiz/icyun/" target="_blank">请点击这里签约</a>',
	...
	'ec_tenpay_tips' => '<li>“财付通”(<a href="http://www.tenpay.com" target="_blank">http://www.tenpay.com</a>)是腾讯公司创办的中国领先的在线支付平台，为 icyun! 用户提供积分购买交易平台。</li><li>如需启用积分充值即时到账，请使用财付通<b>企业版</b>并开通<b>即时到账交易</b>；否则，只需要开通“<b>中介担保交易</b>”即可。</li>
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 icyun! 官方网站或官方论坛另行通知以外， 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Wincomtech! 官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Wincomtech! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'project_option_forum_allowbbcode' => '允许使用 icyun! 代码',
	...
	'project_option_group_allowsigbbcode' => '允许签名中使用 icyun! 代码',
	...
	'project_option_group_allowbiobbcode' => '允许自我介绍中使用 icyun! 代码',
	...
	'filecheck_tips_step1' => '文件校验是针对 icyun! 官方发布的文件为基础进行核对，点击下面按钮开始进行校验',
	...
	'hookcheck_tips_step1' => '嵌入点校验是针对 icyun! 官方发布的文件为基础进行核对，点击下面按钮开始进行校验{template}',
	...
	'dbcheck_tips' => '<li>数据库校验只针对 icyun! 官方发布的数据库结构为基础进行核对</li><li>此工具只对字段的修改以及缺少进行简单的检查，不针对索引的缺少进行处理。</li>',
	'dbcheck_field' => '错误的字段',
	...
	'db_zip' => 'ZIP',
	'db_volume' => '卷数',
	'db_export_tips_nouc' => '<li><font color="blue"><b>您当前的数据备份不包含 UCenter，会影响到您的会员数据，请点击<a href="{uc_backup_url}">这里</a>单独备份 UCenter 数据</b></font></li><li>数据备份功能根据您的选择备份全部数据，导出的数据文件可用“数据恢复”功能或 phpMyAdmin 导入。</li>',
	'db_export_tips_uc' => '<li>数据备份功能根据您的选择备份全部 和 UCenter数据，导出的数据文件可用“数据恢复”功能或 phpMyAdmin 导入。</li>',
	'db_export_tips' => '<li>全部备份均不包含模板文件和附件文件。模板、附件的备份只需通过 FTP 等下载 template/、data/attachment/ 目录即可， 不提供单独备份。</li><li>MySQL Dump 的速度比 Wincomtech! 分卷备份快很多，但需要服务器支持相关的 Shell 权限，同时由于 MySQL 本身的兼容性问题，通常进行备份和恢复的服务器应当具有相同或相近的版本号才能顺利进行。因此 MySQL Dump 是有风险的：一旦进行备份或恢复操作的服务器其中之一禁止了 Shell，或由于版本兼容性问题导致导入失败，您将无法使用 MySQL Dump 备份或由备份数据恢复； 分卷备份没有此限制。</li><li>数据备份选项中的设置，仅供高级用户的特殊用途使用，当您尚未对数据库做全面细致的了解之前，请使用默认参数备份，否则将导致备份数据错误等严重问题。</li><li>十六进制方式可以保证备份数据的完整性，但是备份文件会占用更多的空间。</li><li>压缩备份文件可以让您的备份文件占用更小的空间。</li>',
	'db_export_type' => '数据备份类型',
	'db_export_discuz' => 'icyun! 数据(不含UCenter)',
	'db_export_discuz_uc' => 'icyun! 和 UCenter 数据',
	...
	'db_export_multivol' => 'icyun! 分卷备份 - 文件长度限制(单位：KB)',
	...
	'db_export_discuz_table' => 'icyun! 数据表',
	'db_export_discuz_table_uc' => 'icyun! 和 UCenter 数据表',

	'db_import' => '数据恢复',
	'db_import_confirm' => '导入和当前 icyun! 版本不一致的数据极有可能产生无法解决的故障，您确定继续吗？',
	'db_import_confirm_sql' => '您确定导入该备份吗？',
	'db_import_confirm_zip' => '您确定解压该备份吗？',
	'db_import_tips' => '<li>本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将论坛关闭，恢复全部完成后可以将论坛重新开放。</li><li>恢复数据前请在 Wincomtech! X2.5 安装文件目录下utility文件夹内找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。<b>为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。</b></li><li>您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。</li>',
	...
	'db_runquery' => '数据库升级',
	'db_runquery_tips' => '<li>您可以通过修改 /source/admincp/admincp_quickquery.php 来添加常用 SQL 操作进行功能扩充。</li><li>出于安全考虑， 后台默认情况下禁止 SQL 语句直接执行，只能使用常用 SQL 当中的内容，<br />如果您想自己随意书写 SQL 升级语句，需要将 config/config_global.php 当中的 $_config[admincp][runquery] 设置修改为 1。</li>',
	...
	'adv_list_tip' => '<li>您可以使用“自定义广告位”在页面的任意位置添加广告位。<li>系统广告位位于 source/class/adv/ 目录中，插件广告位位于 source/plugin/插件目录/adv/ 目录中。</li><li>插件开发人员在设计新的广告位前请务必仔细阅读《<a href="http://open.discuz.net/?!devdoc" target="_blank">Hielec! 技术文档</a>》中的内容。</li><li><a href="http://union.discuz.qq.com/?ADTAG=CP.DISCUZ. ADSET.TIP1" target="_blank">Hielec!联盟</a>免费提供更丰富的广告形式，让您赚取更丰厚的广告收益，快来看看吧。</li>',
	...
	'adv_edit_style_code_html_comment' => '请直接输入需要展现的广告的 HTML 代码<br /><a href="http://union.discuz.qq.com/?ADTAG=CP.DISCUZ. ADSET.TIP2" target="_blank">Hielec!联盟</a>算法精准，分成比例高，给您带来更多收益，点击查看详情。',
	...
	'blockxml' => '第三方模块',
	'blockxml_tips' => '<li>插件开发人员在设计新的第三方模块前请务必仔细阅读《<a href="http://open.discuz.net/?!devdoc" target="_blank">Hielec! 技术文档</a>》中的内容。</li>',
	...
	'blockxml_import_ignore_version' => '允许添加老版本 icyun! 的 第三方模块(易产生错误!!)',
	...
	'setting_manyou_search_status_comment' => '漫游搜索是专为 Wincomtech! 产品量身定做的高效、全文搜索服务，无须网站的 MySQL 资源',
	...
	'setting_manyou_base_ip_comment' => '默认为空。如果您的服务器因 DNS 解析问题无法使用MYOP/搜索服务，请填写 MYOP 的 IP 地址。<a href="http://www.wincomtech.cn/viewnews-400" target="_blank">查看 MYOP 的 IP</a>',
