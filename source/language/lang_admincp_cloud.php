...
(
	...
	'menu_cloud_open' => '开通云平台',
	'menu_cloud_upgrade' => '开通云平台',
	...
	'continue' => '继续',
	'message_title' => '提示信息',
	'jump_to_cloud' => '您即将转向云平台（http://cp.discuz.qq.com）完成开通流程',
	'cloud_waiting' => '请稍候...',

	'cloud_status_error' => '出了点小错，由于站点ID/通信KEY等关键信息丢失导致云平台服务出现异常，使用<a href="admin.php?action=cloud&operation=doctor">诊断工具</a>检测站点ID和KEY，如有疑问请访问<a href="http://www.discuz.net/forum-3926-1.html" target="_blank">官方论坛</a>寻求帮助',
	...
	'cloud_time_out' => '您无法访问云平台，请尝试<a href="javascript:;" onClick="location.reload()">刷新</a>。',
	'cloud_unknown_dns' => '您的站点目前无法连接云平台，请检查您服务器网络设置，使用<a href="admin.php?action=cloud&operation=doctor">诊断工具</a>检测DNS解析和接口连通性。<a href="http://cp.discuz.qq.com/faq?fId=1305690058&ADTAG=CP.CLOUD.FAQ.FID" target="_blank">查看帮助</a>，如有疑问请访问<a href="http://www.discuz.net/forum-3926-1.html" target="_blank">官方论坛</a>求助',
	...
	'cloud_manyou_ip_comment' => '若站点服务器由于DNS解析问题无法连接到漫游接口，请填写api.manyou.com的IP地址，使用<a href="admin.php?action=cloud&operation=doctor">诊断工具</a>检测，<a href="http://www.wincomtech.cn/viewnews-400" target="_blank">查看帮助</a>',
	...
	'cloud_doctor_tips' => '<li>Hielec!云平台诊断工具是帮助您分析站点上的状况，是否能与云平台正常通信等功能。</li><li>站点ID是您的站点在云平台的唯一标识，请勿和其他站点共用一套站点ID和站点通信KEY</li>',

	'cloud_doctor_setidkey' => '修改上的站点ID和KEY',
	'cloud_doctor_connect_fix' => '<a href="./admin.php?action=cloud&operation=doctor&op=fixGuest">点击修复</a>',
	'cloud_doctor_setidkey_tips' => '<li style="color:red">修改上的站点ID和KEY，可能会导致通信错误、签名错误以及其他的故障，请勿在没有官方人员指导的情况下修改。</li><li style="color:red">修改ID、KEY和状态前，请先备份论坛的common_setting表。</li>',
	...
	'setting_manyou_base_ip_comment' => '默认为空。如果您的服务器因 DNS 解析问题无法使用漫游应用服务，请填写漫游应用的 IP 地址。<a href="http://www.wincomtech.cn/viewnews-400" target="_blank">查看漫游应用的 IP</a>',
	...
	'qqgroup_msg_unknown_dns' => '抱歉，出现未知错误，请检查您的服务器与云平台连接',
